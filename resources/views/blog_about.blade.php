...
<div class="container-fluid">
  ...
  <div>
    <ul class="navbar-nav">
        ...
        <a class="nav-link" href="{{Session::get('host_name')}}/profile?u_id={{Session::get('u_id')}}"><img src="{{$data[0]->user_img}}" class="img-rounded" style="width:25px;height:25px"> {{Session::get('u_name')}}</a>
        </li>
...
<br>
<div class="div_form">
  <form class="form-horizontal" enctype="multipart/form-data"  method="post" action="{{ URL::to('/save_about') }}">
  {{ csrf_field() }}
      <div class="form-group">
