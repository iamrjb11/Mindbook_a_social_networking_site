...
<div class="div_form">
  <form class="form-horizontal" enctype="multipart/form-data"  method="post" action="{{ URL::to('/change_password') }}">
  {{ csrf_field() }}
      <div class="form-group">
  ...
  <form class="form-horizontal" enctype="multipart/form-data"  method="post" action="{{ URL::to('/change_email') }}">
    {{ csrf_field() }}
        <div class="form-group">
